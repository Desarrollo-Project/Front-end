            ...
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-6">
                ...
                <div className="flex items-center text-gray-600 mb-4">
                  ...
                  <span>Vendedor: {auction.seller.name}</span>
                ...
                <div className="mb-4">
                  <div className="text-sm text-gray-600 mb-1">Puja Actual</div>
                  <div className="text-3xl font-bold text-purple-600">
                    {formatCurrency(auction.currentBid)}
                  </div>
                  <div className="text-sm text-gray-600 mt-1">
                    Comenzó en {formatCurrency(auction.startingPrice)}
                  </div>
                </div>
                
                <div className="mb-6">
                  <div className="text-sm text-gray-600 mb-1">
                    {isEnded ? 'Subasta Finalizada' : 'La Subasta Termina'}
                  </div>
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 mr-2 text-gray-600" />
                    {isEnded ? (
                      <span className="text-red-600 font-medium">Finalizada el {formatDate(auction.endDate)}</span>
                    ) : (
                      <div>
                ...
                {auth.isAuthenticated ? (
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 text-center">
                    <p className="text-gray-700 mb-3">Necesitas iniciar sesión para realizar una puja</p>
            ...
            <div className="border-t border-gray-200 mt-6">
              <div className="px-6 py-4">
                <div className="border-b border-gray-200">
                  <nav className="-mb-px flex space-x-6">
                    ...
                    <button className="whitespace-nowrap py-2 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300">
                      Historial de Pujas ({auction.bids.length})
                    </button>
                    <button className="whitespace-nowrap py-2 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300">
                ...
                <div className="py-4">
                  ...
                  <div className="mt-4">
                    <h3 className="text-lg font-medium text-gray-900">Detalles del Artículo</h3>
                    <div className="mt-2 grid grid-cols-2 gap-4">
                      <div>
                        <span className="text-gray-600">Condición:</span>
                        <span className="ml-2 text-gray-900">Excelente</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Ubicación:</span>
                        <span className="ml-2 text-gray-900">Nueva York, NY</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Método de Pago:</span>
                        <span className="ml-2 text-gray-900">Tarjeta de Crédito, PayPal</span>
                      </div>
                      <div>
                        <span className="text-gray-600">Envío:</span>
                        <span className="ml-2 text-gray-900">Nacional e Internacional</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[...Array(4)].map((_, index) => {
                const relatedAuction = {
                  ...auction,
                  id: `related-${index}`,
                  title: ['Colección de Relojes Vintage', 'Silla Antigua de Madera', 'Lámpara Art Deco', 'Discos de Vinilo Raros'][index],
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <div className="flex items-center text-xs text-gray-500">
                          ...
                          <span>3d 5h restantes</span>
                        </div>
                      </div>
                      <Link to={`/auctions/${relatedAuction.id}`}>
